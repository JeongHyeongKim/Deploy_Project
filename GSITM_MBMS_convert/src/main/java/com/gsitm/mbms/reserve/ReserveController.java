...
import com.gsitm.mbms.util.Mailer;
...
public class ReserveController {
	...
	public ModelAndView doReserve(@RequestBody ReserveHistoryDTO reserveHistory) throws KeyManagementException, InvalidKeyException, NoSuchAlgorithmException, IllegalStateException, IOException {
